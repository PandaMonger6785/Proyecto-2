const SESSION_TIMEOUT = 60 * 1000;  // Tiempo de espera de sesión (1 minuto)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Verificación del usuario y la actividad anterior en sessionStorage
  ...
  if (userStr && lastActivity) {
    ...
    sessionStorage.clear();  // Limpiar sesión si ha pasado el tiempo
  }
  ...
  form.addEventListener('submit', function (e) {
    ...
    sessionStorage.setItem('lastActivity', String(now));  // Guardar última actividad
